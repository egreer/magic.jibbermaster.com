...
export const FOUR_PLAYER = [
  ...
  { id: 5, name: "EDH SYB", initial: 0.15, tags: ["EDH", "SYB"] },
  {
    id: 6,
  ...
  { id: 11, name: "SYB", initial: 0.15, tags: ["SYB"] },
  { id: 12, name: "SYB Deck Swaps", initial: 0.02, tags: ["SYB", "Deck Swaps"] }
];
...
export const FIVE_PLAYER = [
  ...
  { id: 5, name: "EDH SYB", initial: 0.09, tags: ["EDH", "SYB"] },
  {
    id: 6,
    name: "EDH SYB Deck Swaps",
    initial: 0.02,
  ...
  { id: 7, name: "EDH Pentacle", initial: 0.09, tags: ["EDH", "Pentacle"] },
  {
    id: 8,
  ...
  { id: 9, name: "Pentacle", initial: 0.02, tags: ["Pentacle"] },
  {
    id: 10,
  ...
  { id: 12, name: "SYB", initial: 0.02, tags: ["SYB"] },
  {
    id: 13,
    name: "SYB Deck Swaps",
    initial: 0.02,
...
export const SIX_PLAYER = [
  ...
  { id: 5, name: "EDH SYB", initial: 0.85, tags: ["EDH", "SYB"] },
  {
    id: 6,
    name: "EDH SYB Deck Swaps",
    initial: 0.15,
  ...
  { id: 7, name: "EDH Emperor", initial: 0.85, tags: ["EDH", "Emperor"] },
  {
    id: 8,
  ...
  { id: 11, name: "Emperor", initial: 0.1275, tags: ["Emperor"] },
  {
    id: 12,
  ...
  { id: 15, name: "SYB", initial: 0.1275, tags: ["SYB"] },
  {
    id: 16,
    name: "SYB Deck Swaps",
    initial: 0.15,
